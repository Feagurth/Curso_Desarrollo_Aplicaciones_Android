		...
		try
		{
			for (int i = 0; i < json.length(); i++) {
				...
				if(element.getString("type").equals("store"))
				{
					...
					String hoursOfOperaion = element.getString("hoursOfOperation");
					...
					{
						store.setListadoComentarios(Data.ParseComments(element.getJSONArray("comments")));
					}
					...
					if(fotoObj != null){
						...
						{
							foto.setListaComentarios(Data.ParseComments(fotoObj.getJSONArray("comments")));
						}
